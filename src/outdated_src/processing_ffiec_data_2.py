...
#Section 6.1:Grouping into broader asset categories  
...
#Section 7: Summary stats for assets by ban category
...
#Section 7.2: Creating summary stats table
...
#Section 9: Replicating Asset chart from figure A1
